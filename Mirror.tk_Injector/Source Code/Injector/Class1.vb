...
Public Class MephTheme : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.DrawLine(New Pen(New SolidBrush(Color.FromArgb(200, 200, 200))), 1, 1, Width - 2, 1)
...
#End Region
    ...
    Sub New()
        ...
        ForeColor = Color.FromArgb(123, 194, 21)
        DoubleBuffered = True
    End Sub
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.FillPath(New SolidBrush(Color.FromArgb(15, 15, 15)), Draw.RoundRect(ClientRectangle, 3))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(20, 20, 20))), Draw.RoundRect(ClientRectangle, 3))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(20, 20, 20))), Draw.RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), 3))

        Select Case State
            Case MouseState.None
                G.DrawString(Text, drawFont, New SolidBrush(Color.FromArgb(123, 194, 21)), New Rectangle(0, 0, Width - 1, Height - 1), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
            Case MouseState.Over
                G.DrawString(Text, drawFont, Brushes.Lime, New Rectangle(0, 0, Width - 1, Height - 1), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
            Case MouseState.Down
                G.DrawString(Text, drawFont, Brushes.Green, New Rectangle(0, 0, Width - 1, Height - 1), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
        End Select
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Select Case _HeaderLine
            Case HeaderLine.Enabled
                ...
                G.DrawLine(New Pen(New SolidBrush(Color.FromArgb(20, 20, 20))), 20, 30, Width - 16, 30)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.DrawPath(New Pen(Color.FromArgb(20, 20, 20)), Draw.RoundRect(onoffRect, 4))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Dim c As Color() = New Color() {Color.FromArgb(20, 20, 20), Color.FromArgb(20, 20, 20), Color.FromArgb(20, 20, 20), Color.FromArgb(20, 20, 20), Color.FromArgb(20, 20, 20), Color.FromArgb(20, 20, 20), Color.FromArgb(20, 20, 20), Color.FromArgb(20, 20, 20)}
        G.FillPath(New SolidBrush(Color.FromArgb(15, 15, 15)), Draw.RoundRect(ClientRectangle, 3))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        If Not intValue = 0 Then
            ...
            G.DrawLine(New Pen(New SolidBrush(Color.FromArgb(20, 20, 20))), intValue + 1, 3, intValue + 1, Height - 4)
